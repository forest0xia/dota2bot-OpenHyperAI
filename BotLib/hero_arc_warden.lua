...
function X.ConsiderMagneticField()
	...
	then
		...
		and GetUnitToLocationDistance(bot, nLocationAoETarget) <= bot:GetAttackRange()
		then
...
function X.ConsiderSparkWraith()
	...
	then
		...
		then
			local nCreep = J.GetVulnerableUnitNearLoc( bot, false, true, 1600, nRadius, nLocationAoETarget )
			if nCreep == nil
