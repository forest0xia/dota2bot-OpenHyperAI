...
function X.ConsiderQ()
	...
	if nCanHurtEnemyAoECount >= 3 and bot:GetActiveMode() ~= BOT_MODE_RETREAT
	then
	...
	then
		...
		then
			...
			then
				...
				return BOT_ACTION_DESIRE_HIGH, nTargetLocation, "Q对线补刀"..locationAoEKillCount
			end
		end
	end
	...
	then
		...
		then
			...
			if locationAoEKillCount >= 2
	 			and #hAllyList == 1
			then
				nTargetLocation = locationAoEKillTarget
				return BOT_ACTION_DESIRE_HIGH, nTargetLocation, "Q带线1"..locationAoEKillCount
			end
			...
			if ( locationAoEHurtCount >= 3 and #laneCreepList >= 4 )
			then
				nTargetLocation = locationAoEHurtTarget
				return BOT_ACTION_DESIRE_HIGH, nTargetLocation, "Q带线2"..locationAoEHurtCount
			end
		end
	end
...
function X.ConsiderW()
	...
	then
		...
		then
			...
			then
				nTargetLocation = locationAoETarget
				return BOT_ACTION_DESIRE_HIGH, nTargetLocation, "W打钱"..locationAoECount
			end
		end
	end
	...
	then
		...
		then
			...
			then
				nTargetLocation = locationAoEKillTarget
				return BOT_ACTION_DESIRE_HIGH, nTargetLocation, "W带线1"..locationAoEKillCount
			end
			...
			then
				nTargetLocation = locationAoEHurtTarget
				return BOT_ACTION_DESIRE_HIGH, nTargetLocation, "W带线2"..locationAoEHurtCount
			end
		end
	end
