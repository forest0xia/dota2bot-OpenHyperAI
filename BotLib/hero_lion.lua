...
function X.ConsiderQ()
	...
	then
		...
		then
			...
			if locationAoECount >= 3
			then
				nTargetLocation = locationAoETarget
				return BOT_ACTION_DESIRE_HIGH, nTargetLocation, "Q-Farm:"..locationAoECount
			end
		end
	end
	...
	then
		...
		then
			...
			if locationAoECount >= 3
			then
				return BOT_ACTION_DESIRE_HIGH, locationAoETarget, 'Q-Farm neutrals'
			end
		end
	end
