...
function X.ConsiderQ()
	...
	then
		hCastTarget = nCanHurtEnemyAoETarget
	...
	then
		...
		then
			...
			then
				hCastTarget = locationAoETarget
				return BOT_ACTION_DESIRE_HIGH, hCastTarget, "Q-打钱"..locationAoECount
			end
		end
	end
	...
	then
		...
		then
			...
			then
				hCastTarget = locationAoEHurtTarget
				return BOT_ACTION_DESIRE_HIGH, hCastTarget, "Q-带线"..locationAoEHurtCount
			end
		end
	end
