...
function X.ConsiderOverload()
	...
	and bot:HasScepter()
	then
		local nInRangeAlly = J.GetNearbyHeroes(bot,nActivationRadius, false, BOT_MODE_NONE)
		local nInRangeEnemy = J.GetNearbyHeroes(bot,nActivationRadius, true, BOT_MODE_NONE)
