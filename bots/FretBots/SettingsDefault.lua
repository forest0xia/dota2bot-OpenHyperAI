	...
	local settings =
	{
		...
		deathBonus =
		{
			...
			scale =
			{
				gold 			= {1.2, 1.1, 1.0, 0.9, 0.8},
				armor 			= {1.2, 1.1, 1.0, 0.9, 0.8},
				magicResist 	= {1.2, 1.1, 1.0, 0.9, 0.8},
				levels 			= {1.2, 1.1, 1.0, 0.9, 0.8},
				neutral 		= {1.2, 1.1, 1.0, 0.9, 0.8},
				stats 			= {1.2, 1.1, 1.0, 0.9, 0.8},
			},
			-- Enable role scaling?
			scaleEnabled =
			{
