...
3. In the case you saw the bots cannot purchase items, or having some random names or picks (heroes not what you have set or without "OHA" name suffix), 
...
-- The talent upgrade choices. "r" means "right", "l" means "left"
Hero.Talent = {"r", "l", "l", "r"}
