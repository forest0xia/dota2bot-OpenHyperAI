...
local Localization = {
    en = {
        ...
        fret_ally_vote_hint = 'Enter a number (0 to %d)  e.g. vote 0.5 means your ally bots get half of the bonus amount vs the bonus for enemy bots.',
    ...
    zh = {
        welcome_msgs = {
            ...
            "你可以输入 !pos X 与机器人交换位置。例如，输入：`!pos 2` 去中路",
        ...
        fret_ally_scale_open = "现在为您队伍中盟友机器人的奖励比例投票，相对于另一方。默认比例为：",
        fret_ally_vote_hint = "在聊天中输入一个数字（0 到 %d），例如投票 0.5 表示盟友机器人获得的奖励为敌方机器人的一半。",
    ...
    ru = {
        welcome_msgs = {
            ...
            "Вы можете ввести !pos X, чтобы поменяться местами с ботом. Например, введите: `!pos 2`, чтобы пойти на центральную линию.",
        ...
        fret_ally_vote_hint = "Введите число (от 0 до %d), например, голосование за 0.5 означает, что ваши союзные боты получают половину бонуса, чем бонус для вражеских ботов.",
    ...
    ja = {
        welcome_msgs = {
            ...
            "ボットと位置を交換するには、!pos X を入力してください。例: `!pos 2` と入力してミッドレーンに移動します。",
        ...
        fret_ally_vote_hint = "チャットで数字（0 ～ %d）を入力してください。例：0.5 を投票すると、味方ボットのボーナスは敵ボットのボーナスの半分になります。",
