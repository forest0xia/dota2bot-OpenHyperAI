local HeroRoleMap = {
    ...
    ['npc_dota_hero_bane'] = {0, 5, 10, 35, 50},         -- Positions 5,4
    ['npc_dota_hero_batrider'] = {5, 60, 30, 5, 0},      -- Positions 2,3
    ['npc_dota_hero_beastmaster'] = {5, 5, 85, 5, 0},    -- Positions 3, occasional mid
    ['npc_dota_hero_bloodseeker'] = {65, 30, 5, 0, 0},   -- Positions 1,2
    ...
    ['npc_dota_hero_chaos_knight'] = {85, 10, 5, 0, 0},  -- Positions 1,2
    ['npc_dota_hero_chen'] = {0, 5, 10, 20, 65},         -- Positions 5,4
    ...
    ['npc_dota_hero_dark_willow'] = {0, 5, 10, 60, 25},  -- Positions 4,5
    ...
    ['npc_dota_hero_elder_titan'] = {0, 5, 10, 70, 15},  -- Positions 4,5
    ['npc_dota_hero_ember_spirit'] = {15, 80, 5, 0, 0},   -- Positions 2,1
    ['npc_dota_hero_enchantress'] = {0, 5, 10, 35, 50},  -- Positions 5,4, occasional offlane
    ['npc_dota_hero_enigma'] = {0, 5, 85, 10, 0},        -- Positions 3,4
    ['npc_dota_hero_faceless_void'] = {90, 5, 5, 0, 0},  -- Positions 1, occasional mid
    ...
    ['npc_dota_hero_hoodwink'] = {0, 5, 10, 70, 15},     -- Positions 4,5
    ...
    ['npc_dota_hero_juggernaut'] = {90, 5, 5, 0, 0},     -- Positions 1, occasional mid
    ['npc_dota_hero_keeper_of_the_light'] = {0, 5, 10, 35, 50}, -- Positions 5,4
    ['npc_dota_hero_kunkka'] = {5, 85, 5, 5, 0},         -- Positions 2,3
    ['npc_dota_hero_legion_commander'] = {5, 15, 75, 5, 0},-- Positions 3, occasional mid
    ['npc_dota_hero_leshrac'] = {5, 65, 25, 5, 0},        -- Positions 2,3
    ['npc_dota_hero_lich'] = {0, 5, 10, 30, 55},         -- Positions 5,4
    ['npc_dota_hero_life_stealer'] = {60, 5, 35, 0, 0},   -- Positions 1, occasional offlane
    ['npc_dota_hero_lina'] = {25, 50, 5, 20, 0},           -- Positions 2,1
    ['npc_dota_hero_lion'] = {0, 5, 10, 30, 55},         -- Positions 5,4
    ['npc_dota_hero_lone_druid'] = {60, 35, 5, 0, 0},    -- Positions 1,2
    ['npc_dota_hero_luna'] = {90, 5, 5, 0, 0},           -- Positions 1, occasional mid
    ['npc_dota_hero_lycan'] = {45, 5, 45, 5, 0},          -- Positions 3, occasional mid
    ['npc_dota_hero_magnataur'] = {5, 5, 85, 5, 0},      -- Positions 3, occasional mid
    ['npc_dota_hero_marci'] = {0, 5, 10, 70, 15},        -- Positions 4,5
    ['npc_dota_hero_mars'] = {5, 5, 85, 5, 0},           -- Positions 3, occasional mid
    ['npc_dota_hero_medusa'] = {90, 5, 5, 0, 0},         -- Positions 1, occasional mid
    ['npc_dota_hero_meepo'] = {25, 70, 5, 0, 0},          -- Positions 2,1
    ['npc_dota_hero_mirana'] = {0, 5, 10, 65, 20},       -- Positions 4,5
    ['npc_dota_hero_morphling'] = {90, 5, 5, 0, 0},      -- Positions 1, occasional mid
    ['npc_dota_hero_monkey_king'] = {50, 25, 25, 0, 0},   -- Positions 1,2
    ['npc_dota_hero_naga_siren'] = {90, 5, 5, 0, 0},     -- Positions 1, occasional mid
    ...
    ['npc_dota_hero_primal_beast'] = {5, 5, 85, 5, 0},   -- Positions 3, occasional mid
    ['npc_dota_hero_puck'] = {5, 90, 5, 0, 0},           -- Positions 2, occasional support
    ['npc_dota_hero_pudge'] = {5, 5, 80, 5, 5},          -- Positions 3,4,5
    ...
    ['npc_dota_hero_rubick'] = {0, 5, 10, 30, 55},       -- Positions 5,4
    ['npc_dota_hero_sand_king'] = {5, 25, 65, 5, 0},      -- Positions 3,4
    ['npc_dota_hero_shadow_demon'] = {0, 5, 10, 30, 55}, -- Positions 5,4
    ['npc_dota_hero_shadow_shaman'] = {0, 5, 10, 30, 55},-- Positions 5,4
    ['npc_dota_hero_shredder'] = {5, 5, 85, 5, 0},       -- Positions 3, occasional mid
    ...
    ['npc_dota_hero_spectre'] = {90, 5, 5, 0, 0},        -- Positions 1, occasional mid
    ['npc_dota_hero_spirit_breaker'] = {0, 5, 10, 70, 15},-- Positions 4,5
    ['npc_dota_hero_storm_spirit'] = {5, 90, 5, 0, 0},   -- Positions 2, occasional carry
    ...
    ['npc_dota_hero_tinker'] = {5, 90, 5, 0, 0},         -- Positions 2, occasional carry
    ['npc_dota_hero_tiny'] = {5, 5, 85, 5, 0},           -- Positions 3, occasional support
    ...
    ['npc_dota_hero_visage'] = {5, 5, 85, 5, 0},         -- Positions 3, occasional mid
    ['npc_dota_hero_void_spirit'] = {5, 90, 5, 0, 0},    -- Positions 2, occasional carry
    ['npc_dota_hero_warlock'] = {0, 5, 10, 30, 55},      -- Positions 5,4
    ['npc_dota_hero_weaver'] = {5, 5, 10, 65, 15},       -- Positions 4,5, occasional core
    ['npc_dota_hero_windrunner'] = {5, 5, 85, 5, 0},     -- Positions 3,2
    ['npc_dota_hero_winter_wyvern'] = {0, 5, 10, 30, 55},-- Positions 5,4
    ['npc_dota_hero_wisp'] = {0, 5, 10, 45, 40},         -- Positions 4,5
    ['npc_dota_hero_witch_doctor'] = {0, 5, 10, 30, 55}, -- Positions 5,4
    ['npc_dota_hero_zuus'] = {5, 90, 5, 0, 0},           -- Positions 2, occasional support
    ['npc_dota_hero_ringmaster'] = {5, 20, 5, 50, 20},   -- Positions 4,5, occasional core
    ['npc_dota_hero_muerta'] = {70, 5, 5, 15, 5},        -- Positions 1,3, occasional support
}
