...
X["hero_roles"] = {
    ...
    ["npc_dota_hero_ancient_apparition"] = { carry = 1, disabler = 1, durable = 0, escape = 0, initiator = 0, jungler = 0, nuker = 1, support = 2, pusher = 0, ranged = 1, healer = 0 },
    ...
    ["npc_dota_hero_axe"] = { carry = 1, disabler = 2, durable = 3, escape = 0, initiator = 3, jungler = 2, nuker = 1, support = 0, pusher = 0, ranged = 0, healer = 0 },
    ...
    ["npc_dota_hero_batrider"] = { carry = 1, disabler = 2, durable = 0, escape = 1, initiator = 3, jungler = 2, nuker = 1, support = 0, pusher = 0, ranged = 1, healer = 0 },
    ["npc_dota_hero_beastmaster"] = { carry = 1, disabler = 2, durable = 2, escape = 0, initiator = 2, jungler = 0, nuker = 1, support = 0, pusher = 0, ranged = 0, healer = 0 },
    ...
    ["npc_dota_hero_chaos_knight"] = { carry = 3, disabler = 2, durable = 2, escape = 0, initiator = 1, jungler = 0, nuker = 1, support = 0, pusher = 2, ranged = 0, healer = 0 },
    ...
    ["npc_dota_hero_dark_willow"] = { carry = 1, disabler = 3, durable = 0, escape = 0, initiator = 2, jungler = 0, nuker = 1, support = 2, pusher = 0, ranged = 1, healer = 0 },
    ...
    ["npc_dota_hero_earth_spirit"] = { carry = 1, disabler = 1, durable = 1, escape = 2, initiator = 1, jungler = 0, nuker = 2, support = 0, pusher = 0, ranged = 0, healer = 0 },
    ...
    ["npc_dota_hero_jakiro"] = { carry = 1, disabler = 1, durable = 0, escape = 0, initiator = 0, jungler = 0, nuker = 2, support = 1, pusher = 2, ranged = 1, healer = 0 },
    ["npc_dota_hero_juggernaut"] = { carry = 2, disabler = 0, durable = 0, escape = 1, initiator = 0, jungler = 0, nuker = 1, support = 0, pusher = 1, ranged = 0, healer = 1 },
    ...
    ["npc_dota_hero_magnataur"] = { carry = 1, disabler = 2, durable = 0, escape = 1, initiator = 3, jungler = 0, nuker = 1, support = 0, pusher = 0, ranged = 0, healer = 0 },
    ...
    ["npc_dota_hero_nyx_assassin"] = { carry = 1, disabler = 2, durable = 0, escape = 1, initiator = 2, jungler = 0, nuker = 2, support = 0, pusher = 0, ranged = 0, healer = 0 },
    ...
    ["npc_dota_hero_omniknight"] = { carry = 1, disabler = 0, durable = 2, escape = 0, initiator = 0, jungler = 0, nuker = 1, support = 2, pusher = 0, ranged = 0, healer = 1 },
    ["npc_dota_hero_oracle"] = { carry = 1, disabler = 2, durable = 0, escape = 1, initiator = 0, jungler = 0, nuker = 3, support = 3, pusher = 0, ranged = 1, healer = 1 },
    ...
    ["npc_dota_hero_phantom_assassin"] = { carry = 3, disabler = 0, durable = 0, escape = 1, initiator = 0, jungler = 0, nuker = 2, support = 0, pusher = 0, ranged = 0, healer = 0 },
    ["npc_dota_hero_phantom_lancer"] = { carry = 2, disabler = 0, durable = 0, escape = 2, initiator = 0, jungler = 0, nuker = 2, support = 0, pusher = 1, ranged = 0, healer = 0 },
    ["npc_dota_hero_phoenix"] = { carry = 1, disabler = 1, durable = 0, escape = 2, initiator = 2, jungler = 0, nuker = 3, support = 1, pusher = 0, ranged = 1, healer = 1 },
    ...
    ["npc_dota_hero_puck"] = { carry = 1, disabler = 3, durable = 0, escape = 3, initiator = 3, jungler = 0, nuker = 2, support = 0, pusher = 0, ranged = 1, healer = 0 },
    ["npc_dota_hero_pudge"] = { carry = 1, disabler = 2, durable = 2, escape = 0, initiator = 2, jungler = 0, nuker = 1, support = 0, pusher = 0, ranged = 0, healer = 0 },
    ["npc_dota_hero_pugna"] = { carry = 1, disabler = 0, durable = 0, escape = 0, initiator = 0, jungler = 0, nuker = 2, support = 0, pusher = 2, ranged = 1, healer = 1 },
    ...
    ["npc_dota_hero_rattletrap"] = { carry = 1, disabler = 2, durable = 1, escape = 0, initiator = 3, jungler = 0, nuker = 1, support = 0, pusher = 0, ranged = 0, healer = 0 },
    ["npc_dota_hero_riki"] = { carry = 2, disabler = 1, durable = 0, escape = 2, initiator = 0, jungler = 0, nuker = 1, support = 0, pusher = 0, ranged = 0, healer = 0 },
    ...
    ["npc_dota_hero_rubick"] = { carry = 1, disabler = 1, durable = 0, escape = 0, initiator = 0, jungler = 0, nuker = 1, support = 2, pusher = 0, ranged = 1, healer = 0 },
    ["npc_dota_hero_sand_king"] = { carry = 1, disabler = 2, durable = 0, escape = 2, initiator = 3, jungler = 1, nuker = 2, support = 0, pusher = 0, ranged = 0, healer = 0 },
    ...
    ["npc_dota_hero_skywrath_mage"] = { carry = 1, disabler = 1, durable = 0, escape = 0, initiator = 0, jungler = 0, nuker = 3, support = 2, pusher = 0, ranged = 1, healer = 0 },
    ...
    ["npc_dota_hero_snapfire"] = { carry = 1, disabler = 1, durable = 0, escape = 1, initiator = 0, jungler = 0, nuker = 2, support = 3, pusher = 0, ranged = 1, healer = 1 },
    ...
    ["npc_dota_hero_spectre"] = { carry = 3, disabler = 0, durable = 1, escape = 1, initiator = 0, jungler = 0, nuker = 1, support = 0, pusher = 0, ranged = 0, healer = 0 },
    ...
    ["npc_dota_hero_tidehunter"] = { carry = 1, disabler = 2, durable = 3, escape = 0, initiator = 3, jungler = 0, nuker = 1, support = 0, pusher = 0, ranged = 0, healer = 0 },
    ...
    ["npc_dota_hero_venomancer"] = { carry = 1, disabler = 1, durable = 0, escape = 0, initiator = 1, jungler = 0, nuker = 1, support = 2, pusher = 1, ranged = 1, healer = 0 },
    ...
    ["npc_dota_hero_warlock"] = { carry = 1, disabler = 1, durable = 1, escape = 0, initiator = 0, jungler = 0, nuker = 1, support = 3, pusher = 0, ranged = 1, healer = 1 },
    ["npc_dota_hero_weaver"] = { carry = 2, disabler = 0, durable = 0, escape = 3, initiator = 0, jungler = 0, nuker = 1, support = 0, pusher = 0, ranged = 1, healer = 0 },
    ...
    ["npc_dota_hero_winter_wyvern"] = { carry = 1, disabler = 2, durable = 0, escape = 0, initiator = 0, jungler = 0, nuker = 1, support = 3, pusher = 0, ranged = 1, healer = 1 },
